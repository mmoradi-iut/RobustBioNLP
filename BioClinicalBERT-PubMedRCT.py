...
def pubmed_rct():
    ...
    evaluate_every = 500
    lang_model = Path("BioClinicalBERT-PubMedRCT")
    do_lower_case = False
    ...
    label_list = ["background","objective","method","result","conclusion"]
    metric = "micro-f1"

    processor = TextClassificationProcessor(tokenizer=tokenizer,
                                            max_seq_len=128,
                                            data_dir="PubMedRCT-Data",
    ...
    input_address = 'Dataset\\PubMedRCT.tsv'
    basic_texts = []
