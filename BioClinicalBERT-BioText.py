...
def bio_text():
    ...
    evaluate_every = 500
    lang_model = Path("BioClinicalBERT-BioText")
    do_lower_case = False
    ...
    label_list = ["NONE","DISONLY","TREATONLY","PREVENT","VAGUE","TO_SEE","TREAT_FOR_DIS","SIDE_EFF","TREAT_NO_FOR_DIS"]
    metric = "micro-f1"

    processor = TextClassificationProcessor(tokenizer=tokenizer,
                                            max_seq_len=128,
                                            data_dir="BioText-Data",
    ...
    input_address = 'Dataset\\Biotext.tsv'
    basic_texts = []
