...
def med_sts():
    ...
    evaluate_every = 500
    lang_model = Path("BioClinicalBERT-MedSTS")
    do_lower_case = False
    ...
    processor = TextRegressionProcessor(tokenizer=tokenizer,
                                            max_seq_len=128,
                                            data_dir="MedSTS-Data",
    ...
    prediction_head = TextRegressionHead()
    ...
    input_address = 'Dataset\\MedSTS.tsv'
    basic_texts = []
